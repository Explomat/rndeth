...
contract Casino is Ownable {
	uint256 public minimumBet = 1000000000000000; //in wei == 0.1 ether
	...
	// Fallback function in case someone sends ether to the contract so it doesn't get lost and to increase the treasury of this contract 
	...
	function resetData() private onlyOwner{
